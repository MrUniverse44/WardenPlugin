package me.blueslime.wardenplugin.configuration.handlers.bukkit;
...
public class BukkitConfiguration implements me.blueslime.wardenplugin.configuration.ConfigurationSection {
    ...
    @Override
    public me.blueslime.wardenplugin.configuration.ConfigurationSection getMainHandler() {
        return main;
    }

    @Override
    public me.blueslime.wardenplugin.configuration.ConfigurationSection asSection() {
        return this;
    }
     ...
     */
    @Override
    public me.blueslime.wardenplugin.configuration.ConfigurationSection getSection(String path) {
     ...
     */
    @Override
    public me.blueslime.wardenplugin.configuration.ConfigurationSection createSection(String path) {
        return new BukkitConfiguration(this, section.getConfigurationSection(path));
    }
